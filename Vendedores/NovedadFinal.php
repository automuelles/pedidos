...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $intTransaccion = isset($_GET['IntTransaccion']) ? (int) $_GET['IntTransaccion'] : 0;
    $intDocumento = isset($_GET['IntDocumento']) ? (int) $_GET['IntDocumento'] : 0;
    ...
    try {
        ...
        $stmt->bindValue(':inttransaccion', $intTransaccion, PDO::PARAM_INT);
        $stmt->bindValue(':intdocumento', $intDocumento, PDO::PARAM_INT);
