...
if ($transaccion > 0 && $documento > 0) {
    try {
        ...
        $sql_factura = "UPDATE factura SET estado = 'vendedor' WHERE IntTransaccion = :transaccion AND IntDocumento = :documento";
        ...
        $sql_update_gestionada = "UPDATE factura_gestionada SET estado = 'vendedor' WHERE factura_id IN (SELECT id FROM factura WHERE IntTransaccion = :transaccion AND IntDocumento = :documento)";
